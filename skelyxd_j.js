...
var videoSources = {
    series: [
        {
            title: "RWBY 5. évad", 
            ti: "Sorozat Szinopszis", // https://tvtropes.org/pmwiki/pmwiki.php/Recap/RWBYV5E5NecessarySacrifice - Szinopszis
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=5 - részenként rövid leírás
                {
                    ...
                    desc: `<p id="lone">1. rész rövid leírása</p><p id="ltwo">Blake and Sun fail to get enough signatures for their petition to save Haven Academy. Ilia is given orders by the Albains to assassinate Blake's parents and capture Blake.</p>`
                },
                {
                    ...
                    desc: `<p id="lone">2. rész rövid leírása</p><p id="ltwo">Raven explains to Yang and Weiss her distrust in Ozpin after learning about Salem's existence. She shows off her shape shifting ability as proof and offers Yang a choice to stay with her. Yang and Weiss choose to leave and reunite with Ruby.</p>`
                },
                {
                ...
                },
                {
                    ...
                    desc: `<p id="lone">4. rész rövid leírása</p><p id="ltwo">Emotions heighten as Ruby and Weiss discover that Yang has yet to forgive Blake. Illia's internal conflict grows. Blake discovers that her family is in danger.</p>`
                }
            ]
        },
        {
            title: "RWBY: World of Remnant",
            ti: "Sorozat Szinopszis", // https://www.imdb.com/find/?q=World%20of%20Remnant&ref_=nv_sr_srsg_4 - Szinopszis
            ...
            episodes: [ // https://www.imdb.com/title/tt3066242/episodes?season=-1 - részenkénti rövid leírás
                {
                    ...
                    desc: `<p id="lone">1. rész rövid leírása</p><p id="ltwo">The first episode of a supplementary series looking at the history and lore of Remnant. This episode delves into the mysterious power of Dust Crystals.</p>`
                },
                {
